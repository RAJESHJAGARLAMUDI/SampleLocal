...
@PropertySource("file:/F:/config/application.properties")
@ComponentScan(basePackages = { "com.sample.dao", "com.sample.security", "com.sample.service", "com.sample.servlet", "com.sample.rest.controller",
		"com.sample.spring.aop" })
...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	@Bean
	public SampleAppConfig studyAppConfig() {
